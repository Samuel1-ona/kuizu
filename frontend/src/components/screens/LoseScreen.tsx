...
export function LoseScreen() {
  const { lastScore, level, startGame } = useGame();
  ...
  return (
    <div className="screen active">
      <div className="result-card">
        ...
        <p>You need at least {gameConfig.passingScore} correct to pass Level {level}. Try again!</p>

        <div className="result-btns">
          <Button variant="primary" onClick={() => startGame(level)}>🎯 Retry Level {level}</Button>
